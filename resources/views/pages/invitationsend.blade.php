...
<body class="bg-color">
            ...
            <div class="container-fluid">
                <div class="row justi-sec">
                    ...
                    <div class="col-2 bt-se p-0 m-0 text-start">
                        <button type="button" class="button fs-5 fw-bold "><a href="{{url('invitation-send')}}">Invitation</a></button>
                    </div>
                    ...
                    <div class="col-1 text-end p-0 sec-p-page">
                        <button type="button" class="button bt fs-6 fw-bold  text-light" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightresp" aria-controls="offcanvasRightresp">Yes (1)</button>
                    </div>

                    <div class="col-1 text-end p-0 sec-p-page">
                        <button type="button" class="button bt fs-6 fw-bold text-light" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightresp" aria-controls="offcanvasRightresp">Maybe (0)</button>
                    </div>

                    <div class="col-1 text-end p-0  sec-p-page">
                        <button type="button" class="button bt fs-6 fw-bold text-light" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRightPop3" aria-controls="offcanvasRightPop3">No (1)</button>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 text-dark bg-white sec p-5 bg-sec with-50-se mb-5">
                    ...
                    <h5 class="fw-bold font-size text-dark">Monday, May 5</h5>
                    <h5 class="fw-bold font-size text-dark">2:00 PM - 6:00 PM</h5>

                </div>
                <div class="col-lg-6 bg-white p-5 bg-white bg-sec with-50-se mb-5">
                    <h6 class="text-secondary">Where</h6>
                    <h5 class="fw-bold font-size text-dark">India</h5>
                    <h5 class="fw-bold font-size text-dark">Surat, Gujarat</h5>
                    <div class="row">
            ...
            <div class="container-fluid">
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-6 p-0 m-0 text-end">
                        ...
                        <button type="button" class="bg-dark rounded-3 text-light fs-5 fw-normal " data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                            See All Guest</button>
                    </div>
                </div>
            </div>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body m-1">
            <div class="row">
                <div class="col-lg-12">
                    <button class="text-start p-2 bg-sec border border-secondary rounded">
                ...
                <div class="accordion mt-3" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button rounded text-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Yes (2)
                            </button>
                        </h2>
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                <div class="row">
                                    <div class="col-6 text-dark bg-white p-3 bg-sec">
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            <button class="accordion-button collapsed text-light rounded mt-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                Maybe (0)
                            </button>
                        </h2>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            <button class="accordion-button collapsed text-light rounded mt-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                No (0)
                            </button>
                        </h2>
                    </div>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            <button class="accordion-button collapsed rounded mt-3 text-light" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                Not at Replies (0)
                            </button>
                        </h2>
                    </div>
        ...
        <div class="offcanvas-body">
            ...
            <div class="accordion-item mt-5 p-3">
                ...
                <div class="col mt-3 pt-2 pb-2 ">
                    <input type="text" class="form-control p-2 border border-dark" placeholder="Add a Comment..." aria-label="Add a Comment...">
                </div>
